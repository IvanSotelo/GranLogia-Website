...
main(role="main")
  transition(v-on:enter="animateIn" v-bind:css="false" appear)
    section#page-about-us.page.page-about-us
      .page-about-us__background
      .vertical-align
...
export default {
  ...
  methods: {
    ...
    animateIn (el, done) {
      ...
      TweenLite.to(this.$el.querySelector('.page-about-us__background'), 1.3, {
        autoAlpha: 1,
        ease: Expo.easeInOut,
        delay: 1,
        onComplete: () => {
